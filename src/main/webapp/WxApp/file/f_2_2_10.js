...
//统计图方法
function pkcsbbz(){
	var myChart = echarts.init(document.getElementById('wfgz'));//声明id为mapChart的div为图形dom 
	...
	var option = {
		    ...
		    color:["#FE8463","#E4504B","#5D89A7","#B9EFD4"],
		    legend: {
		        data:['标准卫生室个数'],
		        y:'bottom'
		    },
