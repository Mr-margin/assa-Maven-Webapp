...
function biaoge(){
	...
	if(data==0){
    	...
    	$.each(data, function(i,item) {
    		...
    		'<td class="text-center">'+item.fc3+'</td></tr>';
    	});
    	xu=xu+1;
    	html+='<tr><td class="text-center">'+xu+'</td><td class="text-center"><strong>总计</strong></td><td class="text-center"><strong>'+v1+'</strong></td><td class="text-center"><strong>'+v3+'</strong></td></tr>';
		//对下方的表格赋值
...
//统计图方法
function pkcsbbz(){
	 myChart = echarts.init(document.getElementById('ydbq'));//声明id为mapChart的div为图形dom 
