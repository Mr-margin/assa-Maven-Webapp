...
function biaoge(){
	...
	if(data==0){
    	...
    	html1='本辖区校舍建设和改造总平方米数'+parseInt(v1)+'米'
		$("#biaozhu").html(html1);
    	//对下方的表格赋值
...
function pkcsbbz(){
	...
	var data = ajax_async_t("/assa/getWfgz.do",{order:"VG10",name:obj.com,year:obj.year,q1:obj.q1,q2:obj.q2,q3:obj.q3,q4:obj.q4,q5:obj.q5,t1:obj.t1,t2:obj.t2},"json"); //调用ajax通用方法
	var count=[];//名称
	var count2=[];//总数
	var count3=[];//贫困户
