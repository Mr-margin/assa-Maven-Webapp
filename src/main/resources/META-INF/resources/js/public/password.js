...
function xiugaimima(){
	...
	/*$("#popup_2").html('<div class="top_nav" ><div align="center"><i></i><span>修改密码</span><a class="guanbi" onclick='+"xg_guanbi();"+'></a></div></div>'
			...
			+'<h3 class="col-sm-4" style="">请输入原密码：</h3><input type="password" name="old_pass" id="old_pass" style="" required="required" cp="true"  placeholder="原密码" autocomplete="off" class="input_mm">'
			+'<div align="center">&nbsp;&nbsp;&nbsp;</div>'
			+'<h3 class="col-sm-4" style="">请输入新密码：</h3><input type="password" name="new_pass" id="new_pass" style="" required="required"  placeholder="新密码" autocomplete="off" class="input_mm">'
			+'<div align="center">&nbsp;&nbsp;&nbsp;</div>'
			+'<input type="password" name="new_pass_2" id="new_pass_2" style="" required equalTo="#new_pass" placeholder="请再次输入新密码" autocomplete="off" class="input_mm">'
			+'<h3 class="col-sm-4" style="">请再次输入密码：</h3></div></form></div></div>'
			+'<div align="center">'
...
//修改密码方法
function up_password(pkid,new_pass){
	var data = ajax_async_t("/assa/upPassword.do",{pkid:pkid,password:new_pass},"text");
	if (data == "1") {
		toastr["success"]("success", "密码已修改");
		shuaxin_xiugaimima();
		$(".guanbi").click();//关闭弹窗
