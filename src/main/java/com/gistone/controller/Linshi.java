...
//		String text = "http://192.168.0.16:8081/assa/anuser.html?pkid="; //localhost 改成本机的测试
        ...
        if(type.equals("all")){//全部二维码
        	...
        	sql="select * from ("
        			...
        			+"select A1.PKID,A1.CODE,A2.V6,A2.V8 from (SELECT AAC001 PKID,AAR008 CODE  FROM NEIMENG0117_AC01 WHERE AAR100= '1' and AAR040='2016' and AAR010 in ('0','1','3')) a1 "
        			+"LEFT JOIN (SELECT aac001,aab002 v6,AAB004 v8 from NEIMENG0117_ab01 where AAB006='01' AND AAR040='2016' and AAB015 IN ('1','4') "
