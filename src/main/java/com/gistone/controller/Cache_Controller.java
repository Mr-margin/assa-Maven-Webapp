...
//			String sql="select pkid,COM_NAME,com_code,com_level,com_f_pkid from sys_company";
...
//			}
//			OverallSituation.compartment = jsonArray;
...
//		String sql="select pkid,COM_NAME,com_code,com_level,com_f_pkid,lat,lon,status from sys_company where com_level=1";
//		List<Map> list = this.getBySqlMapper.findRecords(sql);
//		
//		String sql_2 = "select pkid,COM_NAME,com_code,com_level,com_f_pkid,lat,lon,status from sys_company where com_level=2 order by com_code";
//		List<Map> list_2 = this.getBySqlMapper.findRecords(sql_2);
//		
//		String sql_3 = "select pkid,COM_NAME,com_code,com_level,com_f_pkid,lat,lon,status from sys_company where com_level=3";
//		List<Map> list_3 = this.getBySqlMapper.findRecords(sql_3);
//		
//		String sql_4 = "select pkid,COM_NAME,com_code,com_level,com_f_pkid,lat,lon,status from sys_company where com_level=4";
//		List<Map> list_4 = this.getBySqlMapper.findRecords(sql_4);
//		
//		String sql_5 = "select pkid,COM_NAME,com_code,com_level,com_f_pkid,lat,lon,status from sys_company where com_level=5";
//		List<Map> list_5 = this.getBySqlMapper.findRecords(sql_5);
