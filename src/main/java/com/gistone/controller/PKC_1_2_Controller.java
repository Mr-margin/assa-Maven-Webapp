...
//		}
	...
	public void getBfzrr(HttpServletRequest request,HttpServletResponse response) throws IOException{
		...
		String sql = "select c.*,round(VB3/VB2,4)*100 AS b5 from PKC_3_1_1 c join (select * from SYS_COMPANY where COM_F_PKID=(SELECT PKID from SYS_COMPANY where COM_NAME='"+name+"') ) b on c.VB1=b.COM_NAME ";
