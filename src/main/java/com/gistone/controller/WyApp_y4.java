...
public class WyApp_y4 {
	...
	public void getWyApp_y4_1(HttpServletRequest request,HttpServletResponse response) throws IOException{
		...
		String sql = "select v21,v22,v23,v6,v9,pic_path from "+
					...
					" left join DA_PIC_CODE on t4.v6=DA_PIC_CODE.HOUSEHOLD_NAME and t4.v8=DA_PIC_CODE.HOUSEHOLD_CARD left join (select COUNT(*) v9,AAC001 from (SELECT aac001,aab002 FROM NM09_AB01  GROUP BY aab002,AAC001 ) GROUP BY AAC001) t5 on T4.AAC001=t5.AAC001 GROUP BY v21,v22,v23,v6,v9,pic_path ORDER BY v6";
