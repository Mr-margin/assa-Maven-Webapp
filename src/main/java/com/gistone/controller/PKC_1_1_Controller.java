...
public class PKC_1_1_Controller {
	...
	public void getPKC_1_1_1(HttpServletRequest request,HttpServletResponse response) throws IOException{
	...
	public void getPKC_1_1_2(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String t1 = request.getParameter("t1");//脱贫标志-返贫
		String t2 = request.getParameter("t2");//脱贫标志-现贫
		String src = "";
		String sql = "SELECT * FROM PKC_1_1_1 WHERE ";
		if(name.equals("全部盟市")){
			name="内蒙古自治区";
		}
		if(name.equals("内蒙古自治区")){
			src += " PKID = 13 or PKID = 20 ";
		}else{
			src += " V1 = '"+name+"' ";
		}
		if(t1.equals("0")||t2.equals("1")){
	...
	public void getPKC_1_1_2_2(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String year = request.getParameter("year");//统计年度
		String q1 = request.getParameter("q1");//旗县分类-国家重点旗县
		String q2 = request.getParameter("q2");//旗县分类-自治区重点旗县
	...
	public void getPKC_1_1_2_3(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String year = request.getParameter("year");//统计年度
		String q1 = request.getParameter("q1");//旗县分类-国家重点旗县
		String q2 = request.getParameter("q2");//旗县分类-自治区重点旗县
	...
	public void getPKC_1_1_3(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String year = request.getParameter("year");//统计年度
		String q1 = request.getParameter("q1");//旗县分类-国家重点旗县
		String q2 = request.getParameter("q2");//旗县分类-自治区重点旗县
...
//	public void getPKC_1_1_3_3(HttpServletRequest request,HttpServletResponse response) throws IOException{
//		String name = request.getParameter("name");//行政区划
//		String tjnd = "";//统计年度
//		String qxfl = "";//旗县分类
//		String tpbz = "0";//脱贫标志
...
//	}
	...
	public void getPKC_1_1_4(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String year = request.getParameter("year");//统计年度
		String q1 = request.getParameter("q1");//旗县分类-国家重点旗县
		String q2 = request.getParameter("q2");//旗县分类-自治区重点旗县
	...
	public void getPKC_1_1_5(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String year = request.getParameter("year");//统计年度
		String q1 = request.getParameter("q1");//旗县分类-国家重点旗县
		String q2 = request.getParameter("q2");//旗县分类-自治区重点旗县
	...
	public void getPKC_1_1_6(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String year = request.getParameter("year");//统计年度
		String q1 = request.getParameter("q1");//旗县分类-国家重点旗县
		String q2 = request.getParameter("q2");//旗县分类-自治区重点旗县
	...
	public void getPKC_1_1_7(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String t1 = request.getParameter("t1");//脱贫标志-返贫
		String t2 = request.getParameter("t2");//脱贫标志-现贫
		String src = "";
		...
		String sql = "SELECT * FROM PKC_1_1_6 WHERE ";
		if(name.equals("内蒙古自治区")){
			src += " PKID = 13 or PKID = 20 ";
		}else{
			src += " V1 = '"+name+"' ";
	...
	public void getPKC_1_1_8(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String t1 = request.getParameter("t1");//脱贫标志-返贫
		String t2 = request.getParameter("t2");//脱贫标志-现贫
		String src = "";
		...
		String sql = "SELECT * FROM PKC_1_1_7 WHERE ";
		if(name.equals("内蒙古自治区")){
			src += " PKID = 13 or PKID = 20 ";
		}else{
			src += " V1 = '"+name+"' ";
	...
	public void getPKC_1_1_9(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String year = request.getParameter("year");//统计年度
		String q1 = request.getParameter("q1");//旗县分类-国家重点旗县
		String q2 = request.getParameter("q2");//旗县分类-自治区重点旗县
	...
	public void getPKC_1_1_10(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String year = request.getParameter("year");//统计年度
		String q1 = request.getParameter("q1");//旗县分类-国家重点旗县
		String q2 = request.getParameter("q2");//旗县分类-自治区重点旗县
	...
	public void getPKC_1_1_10_3(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String name = request.getParameter("name");//行政区划
		String year = request.getParameter("year");//统计年度
		String q1 = request.getParameter("q1");//旗县分类-国家重点旗县
		String q2 = request.getParameter("q2");//旗县分类-自治区重点旗县
